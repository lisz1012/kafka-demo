...
public class Lesson02 {
	public static Properties init() {
		...
		conf.setProperty(ProducerConfig.SEND_BUFFER_CONFIG, "32768"); // TCP的缓冲区大小：netstat -natp中的 Send-Q
		conf.setProperty(ProducerConfig.RECEIVE_BUFFER_CONFIG, "32768"); // TCP的缓冲区大小：netstat -natp中的 Recv-Q
		return conf;
	}
